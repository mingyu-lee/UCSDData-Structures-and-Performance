 ...
 */
public class BasicDocument_bak extends Document_bak
{
	/** Create a new BasicDocument object
	 * 
	 * @param text The full text of the Document.
	 */
	public BasicDocument_bak(String text)
	{
		super(text);
	}
	...
	public int getNumWords()
	{
		...
		List<String> textList = getTokens("[a-zA-z]+");
	...
	public int getNumSentences()
	{
		...
		List<String> textList = getTokens("[^.!?]+");
	...
	public static void main(String[] args)
	{
		 ...
		 */
		testCase(new BasicDocument_bak("This is a test.  How many???  "
		        + "Senteeeeeeeeeences are here... there should be 5!  Right?"),
				16, 13, 5);
		testCase(new BasicDocument_bak(""), 0, 0, 0);
		testCase(new BasicDocument_bak("sentence, with, lots, of, commas.!  "
		        + "(And some poaren)).  The output is: 7.5."), 15, 11, 4);
		testCase(new BasicDocument_bak("many???  Senteeeeeeeeeences are"), 6, 3, 2);
		testCase(new BasicDocument_bak("Here is a series of test sentences. Your program should "
				+ "find 3 sentences, 33 words, and 49 syllables. Not every word will have "
				+ "the correct amount of syllables (example, for example), "
				+ "but most of them will."), 49, 33, 3);
		testCase(new BasicDocument_bak("Segue"), 2, 1, 1);
		testCase(new BasicDocument_bak("Sentence"), 2, 1, 1);
		testCase(new BasicDocument_bak("Sentences?!"), 3, 1, 1);
		testCase(new BasicDocument_bak("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad."),
		         32, 15, 1);
	}
